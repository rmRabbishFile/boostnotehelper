...
//const { storage, folder } = this.resolveTargetFolder()
  ...
  focusNote(selectedNoteKeys, noteKey, pathname) {
    ...
    mainWindow.setTitle(storage.path)
    mainWindow.webContents.openDevTools()
    const csonData = CSON.readFileSync(path.join(storage.path,
                                                  'notes',
                                                  noteKey+'.cson'))
    
    //mainWindow.setTitle(csonData.title)
    mainWindow.setTitle(csonData.title + " - Boostnote")
